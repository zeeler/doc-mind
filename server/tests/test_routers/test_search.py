...
def client(tmp_data_dir, monkeypatch):
    ...
    """)
    conn.execute("INSERT INTO chunks_fts VALUES ('c-search-1', 'doc-search-1', 'Python 是一门强大的编程语言，适用于各种场景。', 'Python入门指南')")
    conn.execute("INSERT INTO chunks_fts VALUES ('c-search-2', 'doc-search-1', '机器学习是人工智能的重要分支，Python 在其中应用广泛。', 'Python入门指南')")
    conn.commit()
    conn.close()
